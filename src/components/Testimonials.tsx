...
const testimonials = [
  {
    ...
    content:
      "Loyola School Harnaut provided me with the foundation I needed to succeed in my engineering career. The teachers are incredibly supportive.",
  ...
  },
  {
    ...
    role: "Parent",
    content:
      "I am amazed by the holistic development of my child. The school focuses not just on academics but also on character building and sports.",
  ...
  },
  {
    ...
    content:
      "The smart classrooms and modern labs make learning so much fun. I am proud to be a student of Loyola School.",
  ...
  },
  {
    ...
    role: "Parent",
    content:
      "The discipline and values instilled in the students here are commendable. The faculty is approachable and dedicated.",
  ...
  },
  {
    ...
    content:
      "My years at Loyola were the best. The extracurricular activities helped me discover my passion for arts.",
    ...
    >
      <div className="max-w-7xl mx-auto px-4 mb-12 text-center">
        <h2
          ...
          className=" text-xl sm:text-4xl font-bold text-[#003366] mb-4 uppercase tracking-tight"
        >
          What People Say
        </h2>
      ...
      <div className="relative w-full flex overflow-x-hidden group">
        <div className="animate-marquee-fast flex whitespace-nowrap group-hover:[animation-play-state:paused]">
          {[...testimonials, ...testimonials].map((testimonial, index) => (
            ...
            >
              <Quote
                className="absolute top-6 right-6 text-[#FFD700] opacity-30"
                size={48}
              />
              <p
                className="text-gray-600 mb-8 text-xs sm:text-base
               relative z-10 italic leading-relaxed"
              >
                "{testimonial.content}"
              </p>
