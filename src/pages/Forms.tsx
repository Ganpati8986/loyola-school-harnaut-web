  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="max-w-[900px] mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-4 no-print">
          <h2 className="text-xl font-bold text-[#002147] uppercase tracking-wider">
            {isApplication ? "Application Form" : "Registration Form"}
          </h2>

          <button
            onClick={handlePrint}
            className={`flex items-center gap-2 px-5 py-2 rounded font-bold text-sm tracking-wider transition-colors shadow text-white ${
              isApplication
        ...
        {/* Selected Form */}
        {isApplication ? <ApplicationForm /> : <RegistrationForm />}
      </div>
    </div>
  );
};
